  ...
  return (
     ...
     <nav className='py-6'>
        ...
        <div className="container flex justify-between items-center mx-auto px-8 md:px-14 lg:px-24 w-full">
            ...
            <div className="hidden md:flex space-x-12 items-center font-bold text-secondary">
                <a href="#">Home</a>
            ...
            <div>
            <a href="#hire"><button className="px-6 py-2 bg-primary text-third font-bold">Hire me</button></a>
            </div>
