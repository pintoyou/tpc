  ...
  return (
     ...
     <nav className=''>
        ...
        <div className="container flex justify-between items-center mx-auto px-8 md:px-14 lg:px-24 w-full">
            ...
            <div className="hidden md:flex space-x-12 mt-8 items-center  text-[14px] font-semibold font-manrope text-secondary">
                <a href="#">Home</a>
            ...
            <a href="#hire"><button className="px-6 py-2 bg-primary rounded-[10px] text-third text-[14px] font-semiboldfont-manrope">Hire me</button></a>
            </div>
